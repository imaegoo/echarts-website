window.__EC_DOC_option_angleAxis = {
  ...
  "startAngle": {
    "desc": "\n\n<p>起始刻度的角度，默认为 90 度，即圆心的正上方。0 度为圆心的正右方。</p>\n<p>如下示例是 startAngle 为 45 的效果：</p>\n<iframe  data-src=\"/echarts4/examples/zh/view.html?c=doc-example/polar-start-angle&edit=1&reset=1\" width=\"400\" height=\"400\"></iframe>\n\n",
    "uiControl": {
      "type": "angle",
      "default": "90",
      "min": "-360",
  ...
  "clockwise": {
    "desc": "\n\n<p>刻度增长是否按顺时针，默认顺时针。</p>\n<p>如下示例是 clockwise 为 <code class=\"codespan\">false</code> （逆时针）的效果：</p>\n<iframe  data-src=\"/echarts4/examples/zh/view.html?c=doc-example/polar-anticlockwise&edit=1&reset=1\" width=\"400\" height=\"400\"></iframe>\n\n\n\n",
    "uiControl": {
      "type": "boolean",
      "default": "true"
    }
