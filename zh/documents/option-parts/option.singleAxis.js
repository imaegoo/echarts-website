window.__EC_DOC_option_singleAxis = {
  ...
  "minorTick": {
    "desc": "<blockquote>\n<p>从 <code class=\"codespan\">v4.6.0</code> 开始支持</p>\n</blockquote>\n<p>坐标轴次刻度线相关设置。</p>\n<p>注意：次刻度线无法在类目轴（<a href=\"#singleAxis.type\">type</a>: <code class=\"codespan\">&#39;category&#39;</code>）中使用。</p>\n<p>示例：</p>\n<p>1) 函数绘图中使用次刻度线</p>\n<iframe  data-src=\"/echarts4/examples/zh/view.html?c=line-function&edit=1&reset=1\" width=\"600\" height=\"350\"></iframe>\n\n\n<p>2) 在对数轴中使用次刻度线</p>\n<iframe  data-src=\"/echarts4/examples/zh/view.html?c=line-log&edit=1&reset=1\" width=\"600\" height=\"350\"></iframe>\n\n"
  },
  "minorTick.show": {
    "desc": "\n\n<p>是否显示次刻度线。</p>\n",
    "uiControl": {
  ...
  "axisPointer.handle": {
    "desc": "<p>拖拽手柄，适用于触屏的环境。参见 <a href=\"/echarts4/examples/zh/editor.html?c=line-tooltip-touch&amp;edit=1&amp;reset=1\" target=\"_blank\">例子</a>。</p>\n"
  },
